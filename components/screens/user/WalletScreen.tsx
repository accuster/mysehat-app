...
export default function WalletScreen({ navigation }: Props) {
  ...
  const baseQuick: QuickAmount[] = useMemo(
    () => [
      ...
      // extra if expanded
      //   { cash: 2000, reward: 100 },
      //   { cash: 5000, reward: 250 },
      //   { cash: 10000, reward: 500 },
    ],
    [],
  );
  ...
  const handleAddBalance = (amt: number) => {
    console.log('Add balance:', amt);
      ...
      <ScrollView showsVerticalScrollIndicator={false}>
        ...
        <View style={styles.sectionCard}>
              ...
              return (
                <View key={q.cash} style={{ width: '48%' }}>
                  <AmountChip
                    ...
                    onPress={() => setAmount(String(q.cash))}
                  />
                </View>
              );
            })}
          ...
          <Pressable
            ...
            style={[
              styles.primaryBtn,
              !parsedAmount && styles.primaryBtnDisabled,
            ]}
          >
